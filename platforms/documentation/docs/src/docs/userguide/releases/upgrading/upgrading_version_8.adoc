...
==== Introduced new variant to Java projects

All plugins that apply the `java` plugin or any of its related plugins will have a new consumable configuration, `privateApiElements`.
This variant has been added to support future changes related to declaring test dependencies.
