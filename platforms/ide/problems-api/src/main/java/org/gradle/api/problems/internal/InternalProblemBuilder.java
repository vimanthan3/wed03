...
public interface InternalProblemBuilder extends InternalProblemSpec {
    ...
    @Override
    <T extends AdditionalData<U>, U extends AdditionalDataSpec> InternalProblemBuilder additionalData(Class<? extends AdditionalData<U>> type, Action<? super U> config);
