...
public class DefaultTypeValidationData implements TypeValidationData {
    ...
    private static class DefaultTypeValidationDataBuilder implements TypeValidationDataSpec, AdditionalDataBuilder<TypeValidationData> {
        ...
        public DefaultTypeValidationDataBuilder(TypeValidationData from) {
            ...
            this.isIrrelevantInErrorMessage = from.isIrrelevantInErrorMessage();
        ...
        public DefaultTypeValidationData build() {
            return new DefaultTypeValidationData(pluginId, isIrrelevantInErrorMessage, propertyName, parentPropertyName, typeName);
        }
        ...
        @Override
        public TypeValidationDataSpec isIrrelevantInErrorMessage(String isIrrelevantInErrorMessage) {
            this.isIrrelevantInErrorMessage = isIrrelevantInErrorMessage;
            return this;
        }
