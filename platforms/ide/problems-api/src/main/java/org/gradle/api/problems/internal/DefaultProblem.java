...
public class DefaultProblem implements Serializable, Problem {
    ...
    private final AdditionalData<? extends AdditionalDataSpec> additionalData;
    ...
    protected DefaultProblem(
        ...
        @Nullable AdditionalData<? extends AdditionalDataSpec> additionalData
    ) {
    ...
    @Override
    public AdditionalData<? extends AdditionalDataSpec> getAdditionalData() {
