...
class TextPreservingTree internal constructor(
    ...
    sealed interface ChildTag {
        sealed interface ValueNodeTag : ChildTag {
            val valueNode: DeclarativeDocument.ValueNode
        }

        data object Name : ChildTag
        data class AssignmentRhs(override val valueNode: DeclarativeDocument.ValueNode) : ValueNodeTag
        data class CallArgument(val index: Int, override val valueNode: DeclarativeDocument.ValueNode) : ValueNodeTag
