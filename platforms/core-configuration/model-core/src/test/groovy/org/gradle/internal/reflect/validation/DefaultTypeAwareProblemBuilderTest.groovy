...
class DefaultTypeAwareProblemBuilderTest extends Specification {
    ...
    def "render introduction without type"() {
        ...
        def data = DefaultTypeValidationData.builder()
            .isIrrelevantInErrorMessage("true")
            .typeName("foo")
            .propertyName("bar")
            .build()

        expect:
        DefaultTypeAwareProblemBuilder.introductionFor(Optional.of(data)) == "Property 'bar' "
    }
    ...
    def "render introduction with type"() {
        ...
        expect:
        DefaultTypeAwareProblemBuilder.introductionFor(Optional.of(data)) == "Type 'foo' property 'bar' "
    }
}
