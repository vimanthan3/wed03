...
import org.gradle.api.problems.internal.DefaultGenericData;
    ...
    private static class AdditionalDataAdapter extends TypeAdapter<AdditionalData<?>> {
        ...
        public void write(JsonWriter out, AdditionalData<?> value) throws IOException {
            ...
            if (value instanceof DeprecationData) {
                ...
                out.name("isIrrelevantInErrorMessage").value(((TypeValidationData) value).isIrrelevantInErrorMessage());
            ...
            } else if (value instanceof GenericData) {
                out.name("type").value("genericData");
                out.name("data");
                out.beginObject();
                Map<String, String> map = ((GenericData) value).getAsMap();
        ...
        public AdditionalData<?> read(JsonReader in) throws IOException {
            if (in.hasNext()) {
                ...
                try {
                    ...
                    String pluginId = null;
                    String isIrrelevantInErrorMessage = null;
                    ...
                    while (in.hasNext()) {
                        ...
                        switch (name) {
                            ...
                            case "isIrrelevantInErrorMessage": {
                                isIrrelevantInErrorMessage = in.nextString();
                                break;
                            }
                            case "propertyName": {
                    ...
                    switch (type) {
                        ...
                        case "typeValidationData":
                            return new DefaultTypeValidationData(
                                pluginId,
                                isIrrelevantInErrorMessage,
                                propertyName,
                                parentPropertyName,
                                typeName
                            );
                        case "genericData":
                            return new DefaultGenericData(genericData);
                        default:
                            throw new JsonParseException("Unknown type: " + type);
                    }
                } finally {
