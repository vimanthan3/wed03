...
"""
        ...
        def groovyModules = ["groovy-${groovyVersion}-indy.jar","groovy-ant-${groovyVersion}-indy.jar", "groovy-astbuilder-${groovyVersion}-indy.jar", "groovy-console-${groovyVersion}-indy.jar", "groovy-datetime-${groovyVersion}-indy.jar", "groovy-dateutil-${groovyVersion}-indy.jar", "groovy-groovydoc-${groovyVersion}-indy.jar", "groovy-json-${groovyVersion}-indy.jar", "groovy-nio-${groovyVersion}-indy.jar", "groovy-sql-${groovyVersion}-indy.jar", "groovy-templates-${groovyVersion}-indy.jar", "groovy-test-${groovyVersion}-indy.jar", "groovy-xml-${groovyVersion}-indy.jar", "javaparser-core-3.17.0.jar"]
